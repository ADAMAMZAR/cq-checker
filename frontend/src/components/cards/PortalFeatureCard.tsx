...
export default function PortalFeatureCard({ item, isAllowed, onSelect }: PortalFeatureCardProps) {
    ...
    <>
      ...
      <div className="relative z-10 flex flex-col gap-3">
        <div className="flex items-center justify-between">
          <div
            className={`w-9 h-9 flex items-center justify-center rounded-lg border transition-all duration-300 shadow-sm ${
              isAllowed
        ...
        <div className="flex flex-col gap-1 mt-1">
          <h2
            className={`font-sans text-base sm:text-lg font-bold leading-snug transition-colors ${
              isAllowed
  ...
  const baseStyles = `group relative flex flex-col justify-between p-5 sm:p-6 rounded-xl border transition-all duration-300 no-underline overflow-hidden text-left ${
    isAllowed
